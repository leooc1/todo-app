...
export default function ListItem(props: ListItemProps) {
    ...
    return (
        <>
            <li className={`px-5 bg-[var(--bg-main)] py-2 border-b-[1px] border-[var(--text-concluded)] rounded-t-md ${props.completed ? 'text-[var(--text-secondary)] line-through' : 'text-[var(--text-hover)]'} flex items-center text-ellipsis h-12`}>
                <button onClick={() => {
                    ...
                    className={`w-7 h-7 flex justify-center items-center rounded-full border border-[var(--text-secondary)] mr-4 ${props.completed ? 'bg-gradient-to-r p-2' : 'p-[13px]'} from-[#57ddff] to-[#c058f3]`}>
